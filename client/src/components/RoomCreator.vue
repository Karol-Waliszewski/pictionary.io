<template>
    <card-modal :visible="isVisible" title="Create a room" transition="fade" @cancel="close" @ok="createRoom" class="section-xs">
        <form class="columns is-multiline">
            <div class="field column is-12">
                <label class="label">Room name</label>
                <div class="control">
                    <input class="input" type="text" placeholder="Enter the name.." v-model="name" required />
                </div>
            ...
            <div class="field column is-6">
                ...
                <div class="control">
                    <input class="input" type="text" placeholder="Text input" v-model="password" :disabled="!isPrivate" />
                </div>
            ...
            <div class="field column is-6">
                ...
                <div class="control">
                    <input class="input" type="number" placeholder="Text input" v-model="maxUsers" min="2" required />
                </div>
            ...
            <div class="column is-6">
                ...
                <div class="field has-addons">
                    <div class="control is-fullwidth">
                        <input class="input" type="number" placeholder="Text input" v-model="roundTime" min="30" required />
                    </div>
                    <p class="control">
            ...
            <div class="column is-6">
                ...
                <div class="field has-addons">
                    <div class="control is-fullwidth">
                        <input class="input" type="number" placeholder="Text input" v-model="wordTime" min="10" required />
                    </div>
                    <p class="control">
                        <a class="button is-static"> s </a>
                    </p>
